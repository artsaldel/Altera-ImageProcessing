// de2i_150_pcie_mm_interconnect_1.v
...
`timescale 1 ps / 1 ps
module de2i_150_pcie_mm_interconnect_1 (
	...
	de2i_150_pcie_mm_interconnect_1_router router (
	...
	de2i_150_pcie_mm_interconnect_1_router_001 router_001 (
	...
	de2i_150_pcie_mm_interconnect_1_router_001 router_002 (
	...
	de2i_150_pcie_mm_interconnect_1_cmd_demux cmd_demux (
		.clk                (pcie_ip_pcie_core_clk_clk),                                 //        clk.clk
		.reset              (pcie_ip_bar2_translator_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	de2i_150_pcie_mm_interconnect_1_cmd_mux cmd_mux (
		.clk                 (pcie_ip_pcie_core_clk_clk),                                 //       clk.clk
		.reset               (pcie_ip_bar2_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	de2i_150_pcie_mm_interconnect_1_cmd_mux cmd_mux_001 (
		.clk                 (pcie_ip_pcie_core_clk_clk),               //       clk.clk
		.reset               (sgdma_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	de2i_150_pcie_mm_interconnect_1_rsp_demux rsp_demux (
		.clk                (pcie_ip_pcie_core_clk_clk),                                 //       clk.clk
		.reset              (pcie_ip_bar2_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	de2i_150_pcie_mm_interconnect_1_rsp_demux rsp_demux_001 (
		.clk                (pcie_ip_pcie_core_clk_clk),                     //       clk.clk
		.reset              (sgdma_reset_reset_bridge_in_reset_reset),       // clk_reset.reset
	...
	de2i_150_pcie_mm_interconnect_1_rsp_mux rsp_mux (
		.clk                 (pcie_ip_pcie_core_clk_clk),                                 //       clk.clk
		.reset               (pcie_ip_bar2_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
