// de2i_150_pcie_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module de2i_150_pcie_mm_interconnect_0 (
	...
	wire  [149:0] rsp_mux_src_data;                                                          // rsp_mux:src_data -> pcie_ip_bar1_0_agent:rp_data
	...
	wire  [150:0] onchip_memory_s1_agent_rf_source_data;                                     // onchip_memory_s1_agent:rf_source_data -> onchip_memory_s1_agent_rsp_fifo:in_data
	...
	wire  [150:0] onchip_memory_s1_agent_rsp_fifo_out_data;                                  // onchip_memory_s1_agent_rsp_fifo:out_data -> onchip_memory_s1_agent:rf_sink_data
	...
	wire  [149:0] pcie_ip_bar1_0_agent_cp_data;                                              // pcie_ip_bar1_0_agent:cp_data -> router:sink_data
	...
	wire  [149:0] onchip_memory_s1_agent_rp_data;                                            // onchip_memory_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [149:0] cmd_mux_src_data;                                                          // cmd_mux:src_data -> onchip_memory_s1_burst_adapter:sink0_data
	...
	wire  [149:0] onchip_memory_s1_burst_adapter_source0_data;                               // onchip_memory_s1_burst_adapter:source0_data -> onchip_memory_s1_agent:cp_data
	...
	wire  [149:0] cmd_demux_003_src0_data;                                                   // cmd_demux_003:src0_data -> cmd_mux_001:sink2_data
	...
	wire  [149:0] cmd_demux_004_src0_data;                                                   // cmd_demux_004:src0_data -> cmd_mux_001:sink3_data
	...
	wire  [149:0] rsp_demux_001_src2_data;                                                   // rsp_demux_001:src2_data -> rsp_mux_003:sink0_data
	...
	wire  [149:0] rsp_demux_001_src3_data;                                                   // rsp_demux_001:src3_data -> rsp_mux_004:sink0_data
	...
	wire  [149:0] rsp_mux_003_src_data;                                                      // rsp_mux_003:src_data -> sgdma_descriptor_read_rsp_width_adapter:in_data
	...
	wire  [113:0] sgdma_descriptor_read_rsp_width_adapter_src_data;                          // sgdma_descriptor_read_rsp_width_adapter:out_data -> sgdma_descriptor_read_agent:rp_data
	...
	wire  [149:0] rsp_mux_004_src_data;                                                      // rsp_mux_004:src_data -> sgdma_descriptor_write_rsp_width_adapter:in_data
	...
	wire  [113:0] sgdma_descriptor_write_rsp_width_adapter_src_data;                         // sgdma_descriptor_write_rsp_width_adapter:out_data -> sgdma_descriptor_write_agent:rp_data
	...
	wire  [113:0] router_003_src_data;                                                       // router_003:src_data -> sgdma_descriptor_read_cmd_width_adapter:in_data
	...
	wire  [149:0] sgdma_descriptor_read_cmd_width_adapter_src_data;                          // sgdma_descriptor_read_cmd_width_adapter:out_data -> cmd_demux_003:sink_data
	...
	wire  [113:0] router_004_src_data;                                                       // router_004:src_data -> sgdma_descriptor_write_cmd_width_adapter:in_data
	...
	wire  [149:0] sgdma_descriptor_write_cmd_width_adapter_src_data;                         // sgdma_descriptor_write_cmd_width_adapter:out_data -> cmd_demux_004:sink_data
	...
	de2i_150_pcie_mm_interconnect_0_router router (
	...
	de2i_150_pcie_mm_interconnect_0_router_001 router_001 (
	...
	de2i_150_pcie_mm_interconnect_0_router_001 router_002 (
	...
	de2i_150_pcie_mm_interconnect_0_router_003 router_003 (
	...
	de2i_150_pcie_mm_interconnect_0_router_003 router_004 (
	...
	de2i_150_pcie_mm_interconnect_0_router_005 router_005 (
	...
	de2i_150_pcie_mm_interconnect_0_router_006 router_006 (
	...
	de2i_150_pcie_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (pcie_ip_pcie_core_clk_clk),                        //       clk.clk
		.reset              (onchip_memory_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	de2i_150_pcie_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (pcie_ip_pcie_core_clk_clk),                  //        clk.clk
		.reset              (sgdma_reset_reset_bridge_in_reset_reset),    //  clk_reset.reset
	...
	de2i_150_pcie_mm_interconnect_0_cmd_demux_002 cmd_demux_002 (
		.clk                (pcie_ip_pcie_core_clk_clk),               //       clk.clk
		.reset              (sgdma_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	de2i_150_pcie_mm_interconnect_0_cmd_demux cmd_demux_003 (
		.clk                (pcie_ip_pcie_core_clk_clk),                                 //       clk.clk
		.reset              (sgdma_reset_reset_bridge_in_reset_reset),                   // clk_reset.reset
	...
	de2i_150_pcie_mm_interconnect_0_cmd_demux cmd_demux_004 (
		.clk                (pcie_ip_pcie_core_clk_clk),                                  //       clk.clk
		.reset              (sgdma_reset_reset_bridge_in_reset_reset),                    // clk_reset.reset
	...
	de2i_150_pcie_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (pcie_ip_pcie_core_clk_clk),                        //       clk.clk
		.reset               (onchip_memory_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	de2i_150_pcie_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		.clk                 (pcie_ip_pcie_core_clk_clk),                        //       clk.clk
		.reset               (onchip_memory_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	de2i_150_pcie_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (pcie_ip_pcie_core_clk_clk),                        //       clk.clk
		.reset              (onchip_memory_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	de2i_150_pcie_mm_interconnect_0_rsp_demux_001 rsp_demux_001 (
		.clk                (pcie_ip_pcie_core_clk_clk),                        //       clk.clk
		.reset              (onchip_memory_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	de2i_150_pcie_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (pcie_ip_pcie_core_clk_clk),                        //       clk.clk
		.reset               (onchip_memory_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	de2i_150_pcie_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (pcie_ip_pcie_core_clk_clk),               //       clk.clk
		.reset               (sgdma_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	de2i_150_pcie_mm_interconnect_0_rsp_mux_001 rsp_mux_002 (
		.clk                 (pcie_ip_pcie_core_clk_clk),               //       clk.clk
		.reset               (sgdma_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	de2i_150_pcie_mm_interconnect_0_rsp_mux rsp_mux_003 (
		.clk                 (pcie_ip_pcie_core_clk_clk),               //       clk.clk
		.reset               (sgdma_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	de2i_150_pcie_mm_interconnect_0_rsp_mux rsp_mux_004 (
		.clk                 (pcie_ip_pcie_core_clk_clk),               //       clk.clk
		.reset               (sgdma_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	de2i_150_pcie_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (66),
		.inUsePackets    (0),
		.inDataWidth     (66),
		.inChannelWidth  (0),
