// de2i_150_pcie_mm_interconnect_2.v
...
`timescale 1 ps / 1 ps
module de2i_150_pcie_mm_interconnect_2 (
	...
	wire   [91:0] cmd_mux_src_data;                                                            // cmd_mux:src_data -> nios2_debug_mem_slave_agent:cp_data
	...
	wire   [18:0] onchip_memory_s2_agent_m0_address;                                           // onchip_memory_s2_agent:m0_address -> onchip_memory_s2_translator:uav_address
	...
	wire  [128:0] onchip_memory_s2_agent_rf_source_data;                                       // onchip_memory_s2_agent:rf_source_data -> onchip_memory_s2_agent_rsp_fifo:in_data
	...
	wire  [128:0] onchip_memory_s2_agent_rsp_fifo_out_data;                                    // onchip_memory_s2_agent_rsp_fifo:out_data -> onchip_memory_s2_agent:rf_sink_data
	...
	wire   [91:0] nios2_debug_mem_slave_agent_rp_data;                                         // nios2_debug_mem_slave_agent:rp_data -> router_002:sink_data
	...
	wire  [127:0] onchip_memory_s2_agent_rp_data;                                              // onchip_memory_s2_agent:rp_data -> router_003:sink_data
	...
	wire   [91:0] cmd_mux_001_src_data;                                                        // cmd_mux_001:src_data -> onchip_memory_s2_cmd_width_adapter:in_data
	...
	wire  [127:0] onchip_memory_s2_cmd_width_adapter_src_data;                                 // onchip_memory_s2_cmd_width_adapter:out_data -> onchip_memory_s2_agent:cp_data
	...
	wire  [127:0] router_003_src_data;                                                         // router_003:src_data -> onchip_memory_s2_rsp_width_adapter:in_data
	...
	wire   [91:0] onchip_memory_s2_rsp_width_adapter_src_data;                                 // onchip_memory_s2_rsp_width_adapter:out_data -> rsp_demux_001:sink_data
	...
	de2i_150_pcie_mm_interconnect_2_router router (
	...
	de2i_150_pcie_mm_interconnect_2_router router_001 (
	...
	de2i_150_pcie_mm_interconnect_2_router_002 router_002 (
	...
	de2i_150_pcie_mm_interconnect_2_router_003 router_003 (
	...
	de2i_150_pcie_mm_interconnect_2_cmd_demux cmd_demux (
		.clk                (clk_50_clk_clk),                          //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	de2i_150_pcie_mm_interconnect_2_cmd_demux cmd_demux_001 (
		.clk                (clk_50_clk_clk),                          //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	de2i_150_pcie_mm_interconnect_2_cmd_mux cmd_mux (
		.clk                 (clk_50_clk_clk),                          //       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	de2i_150_pcie_mm_interconnect_2_cmd_mux cmd_mux_001 (
		.clk                 (clk_50_clk_clk),                          //       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	de2i_150_pcie_mm_interconnect_2_cmd_demux rsp_demux (
		.clk                (clk_50_clk_clk),                          //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	de2i_150_pcie_mm_interconnect_2_cmd_demux rsp_demux_001 (
		.clk                (clk_50_clk_clk),                                       //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset),              // clk_reset.reset
	...
	de2i_150_pcie_mm_interconnect_2_rsp_mux rsp_mux (
		.clk                 (clk_50_clk_clk),                          //       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	de2i_150_pcie_mm_interconnect_2_rsp_mux rsp_mux_001 (
		.clk                 (clk_50_clk_clk),                          //       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	de2i_150_pcie_mm_interconnect_1_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
